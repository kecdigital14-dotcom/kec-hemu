      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 relative">
          ...
          <div className="relative text-center py-4 sm:py-8 rounded-2xl w-full max-w-[800px] mx-auto px-4">
            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold text-green-800">
              Compressed Biogas{" "}
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                <h3 className="text-lg sm:text-xl font-bold">Modern CBG Facility</h3>
            ...
            <div className="bg-white border-2 border-blue-100 rounded-2xl p-6 sm:p-8 shadow-lg">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <div className="w-8 h-8 bg-blue-800 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700 font-medium text-sm sm:text-base">Household & industrial biogas supply</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-800 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700 font-medium text-sm sm:text-base">CBG plant installation & franchising model</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-800 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700 font-medium text-sm sm:text-base">Biogas cylinders distribution network</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-800 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700 font-medium text-sm sm:text-base">Waste-to-energy ecosystem in villages</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
              <div className="bg-gradient-to-br from-green-700 to-green-800 rounded-2xl p-6 text-white shadow-xl">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold">Feedstock Collection & Segregation</h3>
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 text-black shadow-xl border border-gray-100">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-[#205D34] rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                    <span className="text-white font-bold text-lg">2</span>
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold">Biogas Generation</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-green-700 to-green-800 rounded-2xl p-6 text-white shadow-xl">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold">Bottling & Purification</h3>
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 text-black shadow-xl border border-gray-100">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold">Distribution & Sales</h3>
                </div>
