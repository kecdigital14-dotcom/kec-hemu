  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative bg-cover bg-center py-18" style={{
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="inline-block bg-white bg-opacity-20 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
                  <span className=" font-semibold text-sm">STRATEGIC OVERVIEW</span>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative group">
              <div className="aspect-w-16 aspect-h-10 rounded-xl overflow-hidden shadow-lg">
                <img 
                  src="/comprehensivechallen.jpg"
                  alt="Rural farming community with sustainable agriculture practices"
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <h4 className="text-xl font-semibold mb-1">Rural Agriculture Challenges</h4>
                  <p className="text-sm opacity-90">Sustainable farming communities</p>
                </div>
              </div>
            </div>
            
            {/* Right Column - Enhanced Visual Card */}
            <div className="relative">
              <div className="aspect-w-16 aspect-h-10 rounded-xl overflow-hidden bg-gradient-to-br from-yellow-100 to-green-50 shadow-lg">
                <div className="flex items-center justify-center bg-gradient-to-br from-yellow-500 to-green-700 text-white rounded-xl relative">
                  ...
                  <div className="text-center p-8 relative z-10">
                    ...
                    <h4 className="text-xl font-semibold mb-2">Clean Energy Infrastructure</h4>
                    <p className="text-sm opacity-90">CBG plants & solar systems</p>
